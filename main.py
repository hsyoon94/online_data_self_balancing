...
def train_model(day, iteration, model, dataset_dir, data_list, model_save_dir, criterion, optimizer, device):
    ...
    for iter in range(iteration):
        ...
        if MODEL_SAVE is True and iter % 10 == 0:
...
def main():
    ...
    while forever:
        ...
        print("END COLLECTING ONLINE DATA AND START UPDATING DATASET WITH APPENDING NOVEL ONLINE DATA...")
        ...
        print("DATASET UPDATE COMPLETE THEN GET READY FOR NEURAL NETWORK TRAINING...")
