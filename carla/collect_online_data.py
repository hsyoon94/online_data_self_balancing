...
def get_current_time():
    ...
    now_all = str(now.year)[-2:] + str(now.month).zfill(2) + str(now.day).zfill(2) + str(now.hour).zfill(2) + str(now.minute).zfill(2) + str(now.second).zfill(2)
...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            # for tmp_spawn_point in spawn_points:
            #     print(tmp_spawn_point)

            spawn_point = random.choice(spawn_points) if spawn_points else carla.Transform()
            # spawn_point = carla.Transform(carla.Location(x=57.014038, y=-7.778184, z=0.275307), carla.Rotation(pitch=0.000000, yaw=-179.144165, roll=0.000000))
            # spawn_point = carla.Transform(carla.Location(x=57.014038, y=-5.078184, z=0.275307), carla.Rotation(pitch=0.000000, yaw=-179.144165, roll=0.000000))
            self.player = self.world.try_spawn_actor(blueprint, spawn_point)
        # Set up the sensors.
        ...
        self.camera_manager.current_action = self.current_action
...
def game_loop(args):
    ...
    try:
        ...
        # while 5minutes!
        while (int(now_time) - int(start_time)) < running_time_minute * 60:
